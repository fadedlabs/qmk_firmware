...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT_split_3x6_3(KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, LT(1, KC_PIPE)   t, MO(1), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, LT(2, KC_QUOT), KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, LT(3, KC_MINS), KC_LGUI, KC_TAB, KC_ENT, KC_BSPC, KC_SPC, KC_LALT),
...
void matrix_render_user(struct CharacterMatrix *matrix) {
    if (is_master) {
        ...
        matrix_write_ln(matrix, "Faded Layout v1");
